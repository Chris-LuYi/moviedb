...
;// ./src/utils/chrome/post-message.ts
var _window,_window2,_window$__FEDERATION_;const _excluded=["options","moduleInfo","remoteSnapshot"];const getModuleInfo=()=>{return{name:'mf-devtool-getModuleInfo-plugin',loadRemoteSnapshot(_ref){let{options,moduleInfo,remoteSnapshot}=_ref,res=_objectWithoutProperties(_ref,_excluded);const globalSnapshot=helpers.global.getGlobalSnapshot();if(!options||options.inBrowser){window.postMessage({moduleInfo:globalSnapshot,updateModule:moduleInfo},'*');}return _objectSpread2({options,moduleInfo,remoteSnapshot},res);}};};if(!((_window=window)!==null&&_window!==void 0&&_window.__FEDERATION__)){sdk_definePropertyGlobalVal(window,'__FEDERATION__',{});sdk_definePropertyGlobalVal(window,'__VMOK__',window.__FEDERATION__);}if(!((_window2=window)!==null&&_window2!==void 0&&_window2.__FEDERATION__.__GLOBAL_PLUGIN__)){window.__FEDERATION__.__GLOBAL_PLUGIN__=[];}(_window$__FEDERATION_=window.__FEDERATION__.__GLOBAL_PLUGIN__)===null||_window$__FEDERATION_===void 0?void 0:_window$__FEDERATION_.push(getModuleInfo());
/******/ })()
;